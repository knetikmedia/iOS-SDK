...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Knetik"
  # s.authors            = { "Knetik" => "dev@knetik.com" }
  # s.social_media_url   = "http://twitter.com/Knetik"
  ...
  s.source_files  = "JSAPI SDK", "JSAPI SDK/**/*.swift"
  s.exclude_files = "JSAPI SDK/JsapiApiTests"

  # s.public_header_files = "JSAPI SDK/**/*.h"
